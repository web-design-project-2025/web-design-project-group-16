...
function displayReviewElement(review) {
  ...
  profileImageElement.src =
    matchedReviewer?.["picture-of-me"] || "images/profilePicture.jpg";
  ...
  nameElement.textContent =
    matchedReviewer?.name || review.name || "Anonymous Reviewer";
  ...
  usernameElement.textContent =
    matchedReviewer?.["account-name"] || review.username || "@user";
